...
class TestContrastApiNotifyRemediationClosed(unittest.TestCase):
    ...
    def test_put_pr_closed_returns_valid_response_object(self, mock_put):
    ...
    @patch('src.contrast_api.requests.put')
    def test_put_pr_closed_http_error_returns_false(self, mock_put):
    ...
    @patch('src.contrast_api.requests.put')
    def test_put_pr_closed_request_error(self, mock_put):
    ...
    @patch('src.contrast_api.requests.put')
    def test_put_pr_closed_json_error(self, mock_put):
